...
class ValidasiCRUDDataRowAdded extends Seeder
{
    /**
        ...
        try {
            ...
            \DB::table('badaso_data_rows')->insert(array (
                ...
                array (
                    ...
                    'delete' => 1,
                    'details' => '{}',
                    'relation' => '{"relation_type":"belongs_to","destination_table":"validasi","destination_table_column":"id","destination_table_display_column":"ya"}',
                    'order' => 3,
                ),
                3 => 
                array (
